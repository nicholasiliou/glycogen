...
export const DEFAULT_LAYOUTS: Record<string, Record<string, SlotId>> = {
  boids: {
    ...
    size: "knob:8", trail: "fader:0", wrap: "pad:4", dot: "pad:5", reseed: "pad:6",
  },
  contourField: {
    scale: "knob:1", octaves: "knob:2", warp: "knob:3", levels: "knob:4",
    evolveSpeed: "knob:5", swirlSpeed: "knob:6", lineWidth: "knob:7",
  },
  gameOfLife: {
    cellSize: "knob:0", density: "knob:1", speed: "knob:2", trail: "knob:3", gap: "knob:4",
    wrap: "pad:4", reseed: "pad:5",
  },
  harmonograph: {
  ...
  physarum: {
    ...
    deposit: "knob:5", decay: "knob:6", gain: "knob:7", speed: "fader:0",
    textMode: "pad:4", reseed: "pad:5",
  },
  plant: {
    iterations: "knob:0", cameraScale: "knob:1", spinSpeed: "knob:2", evolutionSpeed: "knob:3",
    autoEvolve: "pad:4", opaque: "pad:5",
  },
  reactionDiffusion: {
    pattern: "pad:4", reseed: "pad:5", textMode: "pad:6", iterations: "knob:1",
    gain: "knob:2",
  },
  shape: {
